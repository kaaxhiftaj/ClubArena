...
public class ClubDetailsPhotoAdapter  extends  BaseAdapter{
        ...
        private List<ModelClubDetails> contestents;
        private Context context;
        private LayoutInflater layoutInflater;
        MyViewHolder viewHolder = null;
        public ClubDetailsPhotoAdapter(Context context, List<ModelClubDetails> contestents) {
        ...
        public long getItemId(int i) {
            final ModelClubDetails model=contestents.get(i);
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            viewHolder.imageView=(ImageView)view.findViewById(R.id.iv_club_image);
